...
const SCENARIOS = [
  {
    ...
    turns: [
      ...
      { speaker: "Alice", text: "Tandem, what's on the agenda today?", expect: "speak" },
  ...
  },
  {
    ...
    turns: [
      ...
      { speaker: "Bob", text: "Maybe ask Tandem?", expect: "speak" },
    ]
  },
  {
    name: "AI in conversation then humans pivot",
    turns: [
      { speaker: "Alice", text: "Tandem, summarize the last standup", expect: "speak" },
  ...
  },
  {
    ...
    turns: [
      { speaker: "Alice", text: "Hey Tandem, how's the build looking?", expect: "speak" },
      { speaker: "Bob", text: "Also Tandem, can you check the error logs?", expect: "speak" },
    ]
  },
  {
    name: "Small talk",
  ...
  },
  {
    ...
    turns: [
      { speaker: "Alice", text: "I was testing Tandem yesterday and it crashed", expect: "silent" },
  ...
  },
  {
    ...
    turns: [
      { speaker: "Alice", text: "I think we should use Postgres", expect: "silent" },
      { speaker: "Bob", text: "No way, DynamoDB is better for this", expect: "silent" },
      { speaker: "Alice", text: "Tandem, what do you think?", expect: "speak" },
    ]
  },
];
...
async function main() {
  ...
  console.log(`\x1b[36mtandem gate eval\x1b[0m  (${mode})  \x1b[90mspeak | hand | silent\x1b[0m\n`);
